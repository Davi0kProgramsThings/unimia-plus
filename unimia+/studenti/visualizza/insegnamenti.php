<?php
    ...
    [ $rows, $_ ] = execute_query(
        'SELECT * FROM full_teaching WHERE course=$1 ORDER BY year, semester',
            [ $course ]);
...
<head>
    ...
    <title>Unimia+ | Studenti | Visualizza | Insegnamenti</title>
</head>
                ...
                <tbody>
                    <?php foreach($rows as $row): ?>
                        <tr>
                            ...
                            <td>
                                <a href="/studenti/visualizza/esami.php?corso=<?= $row['course'] ?>&insegnamento=<?= $row['identifier'] ?>">
                                    Visualizza gli esami di questo insegnamento
